...
def generate_prompt(labels):
    ...
    prompt = (
        ...
        "Based on these labels, describe the image in detail, including the setting, time of day, season, "
        "any activities or events, and emotions conveyed. Be creative and thorough."
    )
    return prompt
...
def generate_music_keywords(image_description):
    keyword_prompt = (
        ...
        "Based on this description, suggest up to 5 music genres or keywords suitable for a Spotify search. "
